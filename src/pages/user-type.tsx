...
const UserTypePage = () => {
  ...
  return (
    <main className=" flex flex-col gap-2 p-6 sm:p-12 md:px-[15%] ">
      ...
      <div className="flex flex-col mx-auto   overflow-y-auto hideable_thin_scrollbar gap-2 sm:gap-4 mb-6 mt-6  md:mt-8 sm:w-4/5 lg:w-3/5 max-h-[60vh] md:max-h-[65vh]">
